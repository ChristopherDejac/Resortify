  ...
  return (
    <div className="reg-page">
      ...
      <nav className="reg-nav">
        <Link to="/" className="reg-logo">HanaPin</Link>
      </nav>

      <main className="reg-main">
        <div className="reg-card">
          <h1 className="reg-title">Create Account</h1>
          <p className="reg-subtitle">Fill the details to start your adventure.</p>
      ...
      <footer className="reg-footer">
        <div className="reg-footer-inner">
          <div className="reg-footer-left">
            ...
            <p className="reg-footer-tagline">Discover the heart of Montalban.</p>
          </div>
          <div className="reg-footer-center">
            <a href="/login" className="reg-footer-link">Privacy Policy</a>
            <a href="/login" className="reg-footer-link">Terms of Service</a>
            <a href="/login" className="reg-footer-link">Partner with Us</a>
            <a href="/login" className="reg-footer-link">Contact</a>
          </div>
